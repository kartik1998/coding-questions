...
public class Interleaving_Strings {
    ...
    public static boolean check(String A,String B,String S,int a,int b,int n,Boolean dp[][][]){
        if(a==0 && b==0 && n==0){
        ...
        if(a!=0 && b!=0 && A.charAt(a-1)==S.charAt(n-1) && B.charAt(b-1)==S.charAt(n-1)){
            return dp[a][b][n]=check(A,B,S,a-1,b,n-1,dp) || check(A,B,S,a,b-1,n-1,dp);
        }
